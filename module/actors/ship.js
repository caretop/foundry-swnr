...
import { HULL_DATA } from "./vehicle-hull-base.js";
export class SWNRShipActor extends SWNRBaseActor {
    constructor() {
        super(...arguments);
        this.ENGINE_ID = "SPIKE_DRIVE";
    }
    getRollData() {
                ...
                if (entries && entries.length > 0) {
                    for (const e of entries) {
                        if (e.data.content.indexOf("due") >= 0) {
                            (_c = ui.notifications) === null || _c === void 0 ? void 0 : _c.info(`Reminder: ${e.data.content}`);
                        }
                    }
                }
            }
    ...
    async setScheduledDate(d, type) {
        ...
        if ((_b = (_a = game.modules) === null || _a === void 0 ? void 0 : _a.get("foundryvtt-simple-calendar")) === null || _b === void 0 ? void 0 : _b.active) {
            ...
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            // @ts-ignore
            await SimpleCalendar.api.addNote(title, content, simpleDate, simpleDate, true, 
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            // @ts-ignore
            SimpleCalendar.api.NoteRepeat.Never, ["ship"]);
        }
    }
    prepareDerivedData() {
    ...
    async useDaysOfLifeSupport(nDays) {
        ...
        if (this.data.data.crew.current > 0) {
            ...
            if (newLifeDays <= 0) {
                (_a = ui.notifications) === null || _a === void 0 ? void 0 : _a.error("Out of life support!!!");
            }
        }
    }
    ...
    async rollSpike(pilotId, pilotName, skillMod, statMod, mod, dice, difficulty, travelDays) {
        ...
        if (travelDays > 0) {
            ...
            if (fuel <= 0) {
                (_a = ui.notifications) === null || _a === void 0 ? void 0 : _a.info("Out of fuel...");
            }
    ...
    async _breakItem(id, forceDestroy) {
        ...
        if (id == this.ENGINE_ID) {
            ...
            //console.log(item);
            if (forceDestroy ||
                (item === null || item === void 0 ? void 0 : item.data.data.broken) ||
                (item === null || item === void 0 ? void 0 : item.data.data.juryRigged)) {
                let msg = `${item.name} Destroyed`;
                if (item === null || item === void 0 ? void 0 : item.data.data.juryRigged) {
    ...
    async rollSystemFailure(sysToInclude, whatToRoll) {
        var _a, _b;
        const candidateIds = [];
        ...
        if (sysToInclude.length > 0) {
            (_a = ui.notifications) === null || _a === void 0 ? void 0 : _a.error("Sys to fail not evaluated: " + sysToInclude);
        }
        const msg = [];
        const eitems = [];
        if (whatToRoll == "dest-all") {
            ...
            (_b = ui.notifications) === null || _b === void 0 ? void 0 : _b.error("Sys to fail not evaluated. What to include " + whatToRoll);
            return;
        }
        msg.filter((i) => i != "");
