...
export class SWNRShipFitting extends SWNRBaseItem {
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    async roll(_shiftKey = false) {
        var _a;
        if (this.data.data.broken || this.data.data.destroyed) {
            (_a = ui.notifications) === null || _a === void 0 ? void 0 : _a.error("Fitting is broken/disabled or destroyed. Cannot use!");
            return;
        }
        if (this.actor == null) {
...
//# sourceMappingURL=shipFitting.js.map
